...
{
    static const char *topics[] = {"josue/#", "josue/retain"};
    int qos[]                   = {0, 1};
    err_t err;
    int i;
...
{
    static const char *topic   = "josue/";
    static const char *message = "Josue K64 Board";

    static const char *topic_2   = "josue/retain";
    static const char *message_2 = "Josue K64 Board retain msg";
    ...
    /*Retain message*/
    PRINTF("MQTT publish function with retain flag\r\n");
    mqtt_publish(mqtt_client, topic_2, message_2, strlen(message_2), 1, 1, mqtt_message_published_cb, (void *)topic_2);
